...
<style>
    ...
    <div id="ctl00_ContentPlaceHolder1_dvEng">
        <!-- <h2 class="headline2">
            <span> <?php  echo $_SESSION['contractor_name'];  ?> </span>
            <span> <?php  echo $_SESSION['contractor_address']; ?> </span>
        </h2> -->
        ...
        <br>
        <div align="right" ><span style='font-size: 20px; color: blue; font-weight: bold;'>Equipment Requisition History</span></div>
		<br>
        <!-- <div class="mid_wrap3" style="margin-top: 0px; width: 490px;"> -->
...
<!-- <section id="container"> -->
    <!-- <section id="main-content"> -->
      ...
      <?php
				...
				$sql = "select * from requisition_info where contractor_name='$contractor_name' and contractor_address='$contractor_address'";
				...
				echo "</td>
					 ...
					 if($approval_status == 1 and $equipment_restore_date == NULL)
					 {
					 ...
					 else if($equipment_restore_date != NULL)
					 {
						echo "<a href='bill_details.php? requisition_id=$requisition_id' class='button4'> Bill Details </a>";
					 } 
