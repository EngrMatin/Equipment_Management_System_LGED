...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head id="ctl00_Head1">
		<title> Equipment Requisition </title>
	...
	<?php 
		...
		{
			$sql = "SELECT * FROM road_layer_list Order By layer_name"; 
			$result = mysqli_query($conn, $sql);
			while($row = mysqli_fetch_assoc($result))
			{
				array_push($road_layers, $row['layer_name']);
			}

			$sql = "SELECT * FROM equipment_category Order By equipment_type"; 
			$result = mysqli_query($conn, $sql);
			while($row = mysqli_fetch_assoc($result))
			{
				array_push($equipment_categories, $row['equipment_type']);
			}
	  ...
	  {	  
		...
		if ($_POST['requisition_from_date'] < date('Y-m-d')) 
		{
			echo "<script>alert('Requisition FROM date should not be less than TODAY')</script>";
		}
		else if ($_POST['requisition_to_date'] < $_POST['requisition_from_date']) 
		{
			echo "<script>alert('Requisition TO date should not be less than Requisition FROM date')</script>";
		}
		else 
		{
			$sql ="insert into requisition_info(division_id, district_id, package_no, upazila_id, road_id, road_name, chainage, layer, length, width, thickness, equipment_type, requisition_from_date, requisition_to_date, request_date, contractor_name, contractor_address) values('$division_id', '$district_id', '$package_no', '$upazila_id', '$road_id', '$road_name', '$chainage', '$layer', '$length', '$width', '$thickness', '$equipment_type', '$requisition_from_date', '$requisition_to_date', '$request_date', '$contractor_name', '$contractor_address')";
			// echo $sql; exit("OK");
			...
			if($result == 1)
			{
				...
				header("Location: contractor_dashboard.php?message=".$message);
			}
		}
	  }
    ?>
...
?> 
        ...
        <li><a href="return_equipment_processing.php"><span class="bullet"></span>Return Equipment</a></li>
    ...
    <div id="ctl00_ContentPlaceHolder1_dvEng">
        ...
        <div class="mid_wrap3" style="margin-top: 0px; width: 490px;"><br>
        <div align="center" ><span style='font-size: 20px; color: blue; font-weight: bold;'>Equipment Requisition Form</span></div>
...
<!-- <section id="container"> -->
	...
	<div class="container2">
      <form action="equipment_requisition.php" method="post" name="myform">
	...
	<!-- <div class="container col-md-8"> -->
		...
		<div class="input-box">
          <span class="details"> Contract Package No <span style="color:red">*</span></span>
            <input type="text" name="package_no" placeholder="Enter the Contract Package Number"  required>
        </div>
    ...
    <!-- </div> -->
          ...
          <div class="input-box">
            <span class="details">Chainage <span style="color:red">*</span></span>
            <input type="text" name="chainage" placeholder="Enter the chainage of the road section"  required>
          </div>

          <div class="input-box">
            <span class="details">Layer of the Road <span style="color:red">*</span></span>
              <select class="input-box" name="layer" id="layer" style="height:35px; width:390px;" required>
				<option value="" disabled selected hidden>Select layer </option> 
							  <?php 
								foreach($road_layers as $layer_name)
								{
									echo "<option value=\"$layer_name\">$layer_name</option>";
								}
							  ?>
			  </select>
          </div>
		  ...
		  <div class="input-box">
            ...
            <input type="text" name="length" placeholder="Enter the effective length in meter"  required>
          </div>

		  <div class="input-box">
            <span class="details">Pavement Width (in meter) <span style="color:red">*</span></span>
            <input type="text" name="width" placeholder="Enter the pavement width in meter"  required>
          </div>

		  <div class="input-box">
            <span class="details">Layer Thickness (in mm) <span style="color:red">*</span></span>
            <input type="text" name="thickness" placeholder="Enter the layer thickness in milimeter2"  required>
          </div>

          <div class="input-box">
            <span class="details">Equipment Type <span style="color:red">*</span></span>
               <select class="input-box" name="equipment_type" id="equipment_type" style="height:35px; width:390px;" required>
					<option value="" disabled selected hidden>Select Equipment Type</option> 
							  <?php 
								foreach($equipment_categories as $equipment_type)
								{
									echo "<option value=\"$equipment_type\">$equipment_type</option>";
								}
							  ?>
				</select>
          </div>
          ...
          <div class="input-box">
            <span class="details">Requisition From (date) <span style="color:red">*</span></span>
            <input type="date" name="requisition_from_date" class="form-control" required>
          </div>

          <div class="input-box">
            <span class="details">Requisition To (date) <span style="color:red">*</span></span>
        ...
        <div class="button">
          <input type="submit" name="submit" value="Submit Requisition">
        </div>
      </form>
    </div>
  <!-- </div> -->
