...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head id="ctl00_Head1">
	  ...
	  if(isset($_POST['submit']))
	  {
		...
		$sql ="insert into contractor_info(name, address, mobile, email, password) values('$name', '$address', '$mobile', '$email', '$password')";
    ...
    <ul id="ctl00_ctlLGEDMenu1_dvEn" style="font-size:10px;">      
        ...
        <h2 class="headline2">
            <span>Contractors Registration</span></h2>
	...
	<section class="contractors_section layout_padding-top">
    <div class="container">
      <h2 class="custom_heading">Contractors Registration </h2>
      
      <div class="row layout_padding2">
        <div class="col-md-10">
          <div class="contractor_detail-box">
		  
            
			<form action="contractors_registration.php" method="post" name="myform2">
				<table border="0" cellspacing="0" cellpadding="3" width="100%" height="50%" align="center">
					<thead> 
						<tr>
						  <th colspan="4"><center><marquee><font color="#00CC00"> Welcome to Contractors Registration </font></marquee></center></th>
						</tr>
					</thead>
					
					<tr>
					  	<td > <span id="star">*</span> <b> Name: </b> </td>
						<td> <input type="text" name="name" placeholder="Write your name"></td>
				  	</tr>
				  
				  	<tr>
					  <td> <span id="star">*</span> <b> Address: </b> </td>
					  <td> <input type="text" name="address" placeholder="Write your address"></td>
					</tr
  
				    ><tr>
					  <td> <span id="star">*</span> <b> Mobile: </b> </td>
					  <td> <input type="text" name="mobile" placeholder="Enter your mobile number"></td>
				    </tr>
				  	
					<tr>
						<td> <span id="star">*</span> <b> E-mail: </b> </td>
						<td> <input type="email" name="email" placeholder="Insert E-mail address"></td>
					</tr>
				  
					<tr>
						<td> <span id="star">*</span> <b> Password: </b> </td>
						<td> <input type="password" name="password" placeholder="Enter password"></td>
					</tr>
				<!--	
					<tr>
						<td> <span id="star">*</span> <b> Confirm Password: </b> </td>
						<td> <input placeholder="Re-enter password" type="password" name="password"></td>
					</tr>
				-->
				    <tr>
					  <td> </td>
