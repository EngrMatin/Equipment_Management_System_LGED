...
arrowimages: { down: ['downarrowclass', 'down.gif', 23], right: ['nav_right', 'App_Themes/Default/_lib/common/arrow2.gif'] },
			...
			function(e){
				...
				$targetul.data('timers').showtimer=setTimeout(function(){
					...
					if ($targetul.queue().length<=1){ //if 1 or less queued animations
						$targetul.css({left:menuleft+"px", width:header._dimensions.subulw+'px'}).animate({height:'show',opacity:'show'}, verticalmenu.transition.overtime)
