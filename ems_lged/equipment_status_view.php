	...
	<head id="ctl00_Head1">
		<title> Equipment Status </title>
            ...
            <?php 
                ...
                $sql6 = "select * from districts where district_id='$district_id' ";
					$rec6 = $conn->query($sql6);
					$k=0;
					while($row6 = mysqli_fetch_array($rec6))
					{
						$k++;
						$district 	 			 = $row6['district_name'];
					}
            ?>
...
form .user-details .input-box{
  ...
  .container2.content .category{
	...
	<div align="left" ><span style='font-size: 15px; color: black; font-weight: bold;'><?php  echo $_SESSION['contractor_address'];  ?></span></div>
        ...
        <br>
        <div align="center" style="width: 800px;"><span style='font-size:20px; color:blue; font-weight:bold;'>Current Status of Equipment under LGED <?php  echo $district;  ?> </span></div>
		<br>
...
<div style="width: 800px;">
      <?php
				...
				$cont_district_id      = $_SESSION['district_id'];

                $sql = "SELECT ei.equip_id, ei.division_id, ei.district_id, ei.equipment_id, ei.equipment_weight, ei.hire_charge, ei.allotment_status, ei.location, di.driver_id, di.driver_name, di.driver_mobile_no, ri.requisition_id, ri.upazila_id, ri.road_name, ri.requisition_to_date
                    FROM equipment_info AS ei
                    RIGHT OUTER JOIN driver_info AS di
					...
					AND ri.equipment_restore_date IS NULL
                    HAVING ei.district_id='$cont_district_id'"; 
                ...
                echo "<tr style='background-color:#66cccc; height:30px; color:black;'>
						...
						<th style='text-align:Center; padding-left:5px; padding-right:5px; '> Equipment Weight </th>
						<th style='text-align:Center; padding-left:5px; padding-right:5px; '> Hire Charge </th>
						<th style='text-align:Center; padding-left:5px; padding-right:5px; '> Allotment Status </th>
						...
						<th style='text-align:Center; padding-left:5px; padding-right:5px; '> Driver </th>
						<th style='text-align:Center; padding-left:5px; padding-right:5px; '> Driver's Mobile No </th>
				...
				while($row = mysqli_fetch_array($rec))
				{
					...
					echo "<tr>
							...
							<td style='text-align:Left; padding-left:5px; padding-right:5px; color:black;'> $equipment_weight </td>
							<td style='text-align:Left; padding-left:5px; padding-right:5px; color:black;'> $hire_charge </td>
                        ...
                        echo "</td>
							...
							<td style='text-align:Left; padding-left:5px; padding-right:5px; color:black;'> $driver_mobile_no </td>
