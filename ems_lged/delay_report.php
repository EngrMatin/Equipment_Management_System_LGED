...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head id="ctl00_Head1">
		<title> Temporary Delay Report </title>
        ...
        <?php 
			...
			session_start();
        		...
        		if(isset($_POST['submit']))
				{
					...
					$sql2 = "update requisition_info set delay_cause='$delay_cause', delay_start='$delay_start'  where requisition_id='$requisition_id'";
...
<!-- <section id="container"> -->
	...
	<div class="container2">
      <form action="delay_report.php" method="post" name="myform">
        <div class="user-details">
		  
		  <div class="input-box">
            <span class="details">Cause of temporary delay: <span style="color:red">*</span></span>
            <input type="text" name="delay_cause" placeholder="Enter the cause of temporary delay"  required>
          </div>

        </div>
        
        <div class="button">
          <input type="submit" name="submit" value="Submit Delay Report">
