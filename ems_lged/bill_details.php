...
<style>
    ...
    <div style="width:900px;" class="mid">
                    
    <div id="ctl00_ContentPlaceHolder1_dvEng"><br>
        <h2 style="width:350px;" class="headline2">
			  ...
			  ?>
					...
					<table border="1" cellpadding="0" cellspacing="0" style='margin:20px; width:95%;'>
						...
						<tr>
							...
							<td class="td"><?php  echo $contractor_name;  ?></td>
						</tr>
