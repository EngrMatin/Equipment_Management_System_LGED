  ...
  <body>
    ...
    <section id="main-content">
      <section class="wrapper">
	  	<div>
			<div class="div1" align="center">Pending Requisition List</div>
          ...
          <div class="col-md-12">
            <div class="content-panel">
			  ...
			  <?php
				...
				{
					$sql = "select * from requisition_info where forwarding_status=0 and proposal_status=0 and approval_status=0";
				}
				else if($role_id == 21 or $role_id == 23)
				{
					$sql = "select * from requisition_info as ri where ri.district_id='$user_district_id' and forwarding_status=0 and proposal_status=0 and approval_status=0";
				}
			  	else if ($role_id == 31)
				{
					$sql = "select * from requisition_info as ri where ri.district_id='$user_district_id' and ri.upazila_id='$user_upazila_id' and forwarding_status=0";
				}
            ...
            echo "</tr>
				...
				while($row = mysqli_fetch_array($rec))
				{
					...
					echo "<tr style='color:black; '>
						...
						if ($role_id == 31)
						{
							echo "<a href='requisition_verification.php? requisition_id=$requisition_id' class='button4'> Forward </a>"; 
						}
						else if($role_id == 21)
						{
						...
						{
						 	echo "<a href='allotment_processing.php? requisition_id=$requisition_id' class='button2'> Proceed </a>";
						}
