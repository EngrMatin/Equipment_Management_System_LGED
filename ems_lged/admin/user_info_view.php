	...
	?>
		...
		<section id="main-content">
			<section class="wrapper">
				<div>
					<div class="div1" align="center">User Information</div>
							...
							<div>
								<table border="1" width="100%" cellpadding="0" cellspacing="0"
									...
									<!-- <tr style="height:40px;color:#000000">
										<th width="200px" style="text-align:left; padding-left:15px;">Sl No.:</th>
										<td style="padding-left:15px;"><?php  echo $i;  ?></td>
									</tr> -->
									<tr style="height:40px;color:#000000">
