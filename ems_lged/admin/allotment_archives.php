  ...
  <body>
    ...
    <section id="main-content">
      <section class="wrapper">
	  	<div>
			<div class="div1" align="center">Allotment Archives</div>
          ...
          <div class="col-md-12">
            <div class="content-panel">
			  ...
			  <?php
				...
				{
					$sql = "select * from requisition_info where approval_status=1 and equipment_restore_status=1";
				}
				else if($role_id == 21 or $role_id == 23)
				{
					$sql = "select * from requisition_info as ri where ri.district_id='$user_district_id' and approval_status=1 and equipment_restore_status=1";
				}
				else if ($role_id == 31)
				{
					$sql = "select * from requisition_info as ri where ri.district_id='$user_district_id' and ri.upazila_id='$user_upazila_id' and approval_status=1 and equipment_restore_status=1";
				}
				...
				while($row = mysqli_fetch_array($rec))
				{
					...
					echo "<tr style='color:black;'>
						...
						<a href='bill_details_admin.php? requisition_id=$requisition_id' class='button4'> Bill Details </a>
