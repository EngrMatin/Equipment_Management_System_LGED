	...
	?>
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div>
					<div class="div1" align="center"> Allotment History of Equiments </div>
				</div>
				<div class="row" >
					<div class="col-md-12" >
				...
				<?php
					...
					// echo "<form action='allotment_history_report2.php' method='post'>";
			
					// echo "<tr style='height:20px;'></tr>
					// <tr bgcolor='#87CEFA'>
                    // <td style='width:100px; font-weight:bold; color:black; padding:20px;'>Division: </td>
					// <td>
						
					
					// </td>
                    // <td style='width:100px; font-weight:bold; color:black; padding:20px;'>District: </td>
					// <td>
			...
			<?php
				...
				if(isset($_POST['generate_report'])) 
				{
					...
					if($role_id==8)
					{
						$sql = "SELECT * FROM requisition_info where approval_status=1 and requisition_to_date between '$report_start_date' and '$report_end_date' ";
					}
					else if($role_id==9 or $role_id==11)
					{
						$sql = "SELECT * FROM requisition_info where approval_status=1 and division_id=$user_division_id and district_id=$user_district_id and requisition_to_date between '$report_start_date' and '$report_end_date' ";
					}
					
					if(!empty($equipment_id)) $sql .= "and equipment_id='$equipment_id'";	
					...
					echo "<tr style='background-color:#66cccc; height:30px; color:black; font-weight:bold;'>
						...
						<th style='text-align:Center; padding-left:5px; padding-right:5px;'> Equipment Restore date </th>
					...
					while($row = mysqli_fetch_array($record))
					{
						...
						$hire_charge = $equipment_used_days*3000;
						...
						echo "<tr style='height:30px; text-align:center; color:black; '>
							...
							$total_used_days += $equipment_used_days;
							$total_hire_charge += $hire_charge;
					}
					...
					<td style='font-size: 14px; font-weight:bold; '> $total_used_days </td>		
					<td style='font-size: 14px; font-weight:bold; '> $total_hire_charge </td>	
