  ...
  <body>
    ...
    <section id="main-content">
      <section class="wrapper">
	  	<div>
			<div class="div1" align="center">Forwarded Requisition List</div>
          ...
          <div class="col-md-12">
            <div class="content-panel">
			  ...
			  <?php
				...
				{
					$sql = "select * from requisition_info where forwarding_status=1 and proposal_status=0";
				}
				else if($role_id == 21 or $role_id == 23)
				{
					$sql = "select * from requisition_info as ri where ri.district_id='$user_district_id' and forwarding_status=1 and proposal_status=0";
				}
				else if ($role_id == 31)
				{
					$sql = "select * from requisition_info as ri where ri.district_id='$user_district_id' and ri.upazila_id='$user_upazila_id' and forwarding_status=1 and proposal_status=0";
				}
