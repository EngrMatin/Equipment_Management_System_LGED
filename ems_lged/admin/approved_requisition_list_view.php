  ...
  <body>
    ...
    <section id="main-content">
      <section class="wrapper">
	  	<div>
			<div class="div1" align="center">Approved Requisition List</div>
          ...
          <div class="col-md-12">
            <div class="content-panel">
			  ...
			  <?php
				...
				{
					$sql = "select * from requisition_info where approval_status=1 and equipment_restore_status=0";
				}
				else if($role_id == 21 or $role_id == 23)
				{
					$sql = "select * from requisition_info as ri where ri.district_id='$user_district_id' and approval_status=1 and equipment_restore_status=0";
				}
				else if ($role_id == 31)
				{
					$sql = "select * from requisition_info as ri where ri.district_id='$user_district_id' and ri.upazila_id='$user_upazila_id' and approval_status=1 and equipment_restore_status=0";
				}
                ...
                echo "<tr style='background-color:#66cccc; height:30px; text-align:center; color:black; font-weght:bold;'>
					...
					if ($role_id == 21 or $role_id == 23 or $role_id == 31)
					{
						echo "<th style='text-align:Center; padding-left:5px; padding-right:5px;'>Address</th>";
					}
				...
				echo "<div><tbody style='height:400px; overflow-y:auto'>";
				...
				while($row = mysqli_fetch_array($rec))
				{
					...
					echo "<tr style='color:black;'>
						...
						if ($role_id == 21 or $role_id == 23 or $role_id == 31)
						{
							echo "<td style='text-align:Left; padding-left:5px; padding-right:5px;'> $contractor_address</td>";
						}
						
						echo "<td style='text-align:Left; padding-left:5px; padding-right:5px;'>
						
						<a href='allotment_details_admin.php? requisition_id=$requisition_id' class='button2'> Allotment Details </a>
