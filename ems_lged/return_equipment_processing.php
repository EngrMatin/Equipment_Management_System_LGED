...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head id="ctl00_Head1">
		<title> Return Equipment Processing </title>
...
<!-- <section id="container"> -->
    <!-- <section id="main-content"> -->
      ...
      <?php
				...
				$sql = "select * from requisition_info where contractor_name='$contractor_name' and contractor_address='$contractor_address' and approval_status=1 and equipment_return_status=0";
				...
				echo "</td>
					 ...
					 {
						 echo "<a href='return_equipment.php? requisition_id=$requisition_id' class='button3'> Return Equipment </a>";
					 } 
