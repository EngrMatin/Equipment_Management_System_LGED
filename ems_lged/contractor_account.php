...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head id="ctl00_Head1">
		<title> Contractor Account </title>
  ...
  .container2.content .category{
	...
	<div id="menu2" class="verticalmenu-v">
      ...
      <ul id="ctl00_ctlLGEDMenu1_dvEn" style="font-size:10px;">  
        <li><a href="change_contractor_password.php"><span class="bullet"></span>Change Password</a></li>  
<?php   
		if($active_status==1)
		{
?>
...
?> 
	...
	<section id="main-content">
      <section class="wrapper">
	  	<div><br>
			<div class="div1" align="center"><span style='font-size: 20px; color: blue; font-weight: bold;'>Contractor Account Details</div><br>
			<!-- <div class="div2" align="right">
				<a href="change_contractor_password.php" class="button1">Change Password</a>
			</div> -->
		</div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
			  	...
			  	<div class="table">
					<table border=".1" width="100%" cellpadding="5" cellspacing="5">
						<tr>
							<th width="120px;" style="text-align:left; padding-left:10px;">Name :</th>
							<td style="padding-left:15px;"><?php echo $contractor_name;  ?></td>
						</tr>
						<tr>
							<th width="100px;" style="text-align:left; padding-left:10px;">Address :</th>
							<td style="padding-left:15px;"><?php echo $contractor_address;  ?></td>
						</tr>
						<tr>
							<th width="00px;" style="text-align:left; padding-left:10px;">Mobile :</th>
							<td style="padding-left:15px;"><?php echo $contractor_mobile;  ?></td>
						</tr>
						
						<tr>
							<th width="100px;" style="text-align:left; padding-left:10px;">E-mail :</th>
							<td style="padding-left:15px;"><?php echo $contractor_email;  ?></td>
						</tr>

						<tr>
							<th width="100px;" style="text-align:left; padding-left:10px;">Password :</th>
							<td style="padding-left:15px;"><?php echo $contractor_password;  ?></td>
						</tr>

						<tr>
							<th width="100px;" style="text-align:left; padding-left:10px;">Account Status :</th>
							<td style="padding-left:15px;">
							    <?php 
									 ...
									 {
										echo '<span style="color:red; font-weight:bold;">Deactivated</span>';  
									 }
								?>
							</td>
						</tr>
			...
			?>
							<tr>
								<th width="100px;" style="text-align:left; padding-left:10px;">Registered under :</th>
								<td style="padding-left:15px;"><?php echo "Executive Engineer's Office, LGED, ".$district;  ?></td>
							</tr>
			<?php				
						}
			?>			
