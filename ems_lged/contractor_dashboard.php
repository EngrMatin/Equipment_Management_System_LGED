            ...
            <div class="main">
                <div class="left">
                    <div class="boxheader5">
                        <div>
                            <span id="ctl00_lblMainMenuTitle" class="label">Dashboard</span>
                        </div>
                    </div>
...
?>  
    ...
    <div id="ctl00_ContentPlaceHolder1_dvEng">
        <h2 class="headline2">
            <span> <?php  echo $contractor_name;  ?></span></h2>
...
<!-- <section id="container"> -->
	...
	<div align="center" ><span style='font-size: 20px; color: blue; font-weight: bold;'>Instructions</span></div><br>
      <?php  
	  echo "<ol style='color:black; '>
                <li> Go to <b>Account Details</b> to view your account information </li>
                <li> Go to <b>Account Details</b> -> <b>Change Password</b> to change the current password </li>
                <li> Go to <b>View Equipment Status</b> to view current status of all the equipment </li>
                <li> Go to <b>Submit Requisition</b> to submit request for requisition of any equipment </li>
                <li> Go to <b>Requisition Status</b> to view current status of your Requisition Requests </li>
                <li> Go to <b>Return Equipment</b> to return the equipment after using it. </li>
                <li> Go to <b>Requisition History</b> to view the history of all requisitions made by you. </li>
                <li> Go to <b>Requisition History</b> -> <b>Bill Details</b> to view the details of Hire Charge bill. </li>
                <li> Click on <b>Dashboard</b> to return to the dashboard page </li>
