...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
    	<div id="ctl00_divBody" style="font-family:Verdana,Arial, Helvetica, sans-serif;font-size:11px;">
        	<form name="aspnetForm" method="post" action="LGEDAboutUS.php" id="aspnetForm">
			<div>
				<input type="hidden" name="ctl00_ToolkitScriptManager1_HiddenField" id="ctl00_ToolkitScriptManager1_HiddenField" value="" />
				<input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="" />
				<input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="" />
				<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="" />
			</div>
	...
	<script type="text/javascript">
		...
		<script src="/WebResource.axd?d=YN5gnEfZxDkA49dIhgSfDHUKmEgHpsoIicKwFp_v1Ud27FOO-ui3T36G94q9NXvyFuA34OLrDvWnWdsiZlR64KD_dC41&amp;t=636041026940000000" type="text/javascript">
		</script>


		<script src="/ScriptResource.axd?d=Sb863ajsgbyzrfR_TcR4aBDu95CGZmhW9xE4JcKkBA7Jz6lvx4_ULF2OtFoTxaL2-YpFxrs1VRLOLK5FkaAnF9FqEZet-k41IT9iqO65kF2ZPNxZPCamLrIIRrC69Fy38aL1rUWz8itbxd2Chtg5q89OmbNTLUGgtS_XW6D6a5wm_TCh0&amp;t=3f4a792d" type="text/javascript">
		</script>
		<script type="text/javascript">
			//<![CDATA[
		...
		<script src="/ScriptResource.axd?d=ndEpl9cFF6FMAhLjgawei269iEfygVnPcNBuJkLOGvd0oBtlsQyXeJPXPRrY1eiXk8IaDUSkwOYAibwWIgbvxwP6JvtEWwR1v4RSIlNW4R1G7mmJ2IXrkNp8-tncUTnsdx4St8NmxOWyFSFnwYnJDEnjs37F9yUTQKzoDYXVj5YlZ3F50&amp;t=3f4a792d" type="text/javascript">
		</script>
		<script src="/LGEDAboutUS.php?_TSM_HiddenField_=ctl00_ToolkitScriptManager1_HiddenField&amp;_TSM_CombinedScripts_=%3b%3bAjaxControlToolkit%2c+Version%3d3.0.30512.32943%2c+Culture%3dneutral%2c+PublicKeyToken%3d28f01b0e84b6d53e%3aen-US%3ab0c95330-b069-4689-bee2-146971cb82a5%3a865923e8%3a411fea1c%3ae7c87f07%3a91bd373d%3afc56e238" type="text/javascript">
		</script>
		<div>
				...
				<span class="toggleBtn">
					...
					<ul id="ctl00_Header1_ulEn" class="top_nav">
					    ...
					    <li class="header__nav-item pos-relative">
							<a href="#" class="header__nav-link">Contractor's Section</a>
							<ul class="dropdown__menu pos-absolute">
							  <li class="dropdown__list">
								<a href="contractors_registration.php" class="dropdown__link d-flex justify-content-between align-items-center">Register</a>
								<a href="contractors_login.php" class="dropdown__link d-flex justify-content-between align-items-center">Log in</a>
							  </li>
							</ul>
						</li>
						-->
	...
	<div id="menu2" class="verticalmenu-v">
		...
		<div id="ctl00_ContentPlaceHolder1_dvEng">
			<h2 class="headline2">
				<span>About LGED</span></h2>
			<div class="mid_wrap3" style="margin-top: 0px; width: 490px;">
				<div>
					<img src="images/lged_1.gif" width="480" alt="LGED" title="LGED" />
				</div>
				<br />
				<div>
					<p>
				...
				<br />
				<div>
					<img src="images/functions.gif" width="480" alt="Functions" />
				</div>
				<br />
				<center>
					<span>The detail functions of LGED are described under the section of 'Functions of
						LGED'</span></center>
				<br />
				<div class="widget">
					<div class="statement" style="padding-top: 10px;">
						<h2>
							Mission</h2>
					...
					<div id="ctl00_rightDiv" class="right">
						...
						<div class="box2">
							<div style="margin-top: 4px; height: 140px;">
								<div class="news_title" style="margin: 0; text-align: center;">
									<br />
									<a id="ctl00_HyperLink2" href="AboutLGRDMinister.php"><img id="ctl00_Image3" src="images/OthersPersonnel/min_TajulIslam.jpg" style="height:110px;width:90px;border-width:0px;margin: Center;" /></a>
									<br />
									...
									<br />
									<a id="ctl00_HyperLink6" href="AboutLGRDMinister.php"><span id="ctl00_lblMinisterDetail" class="label">Details</span></a></div>
							</div>
						</div>
						...
						<div class="box2">
							<div style="margin-top: 4px; height: 160px;">
								<div class="news_title" style="margin: 0; text-align: center;">
									<br />
									<a id="ctl00_HyperLink7" href="AboutLGRDStateMinister.php"><img id="ctl00_Image4" src="images/OthersPersonnel/min_State.jpg" style="height:110px;width:90px;border-width:0px;margin: Center;" /></a><br />
									...
									<a id="ctl00_HyperLink9" href="AboutLGRDStateMinister.php"><span id="ctl00_lblStateMinisterDetail" class="label">Details</span></a></div>
							</div>
						</div>
						
						<div class="boxheader5">
							<div id="ctl00_div4">
								<span id="ctl00_lblSecterayHeader" class="label">Senior Secretary</span></div>
						</div>
						<div class="box2">
							<div style="margin-top: 4px; height: 160px;">
								<div class="news_title" style="margin: 0; text-align: center;">
									<br />
									<img id="ctl00_Image5" src="images/OthersPersonnel/Secretary-Ibrahim.jpg" style="height:110px;width:90px;border-width:0px;margin: Center;" />
									<br />
						...
						<div class="box2">
							...
							<div style="margin-top: 4px; height: 160px;">
								<div class="news_title" style="margin: 0; text-align: center;">
									<img id="ctl00_Image1" src="images/PersonnelPhoto/Sk-Md-Mohsin.jpg" style="height:110px;width:90px;border-width:0px;margin: Center;" />
									<br />
	...
	<div class="boxheader5">
		<div>
			<span id="ctl00_ctlPublicProcumbment1_lblTitle" class="label">Public Procurement</span>
		</div>
	</div>
	<div id="ctl00_ctlPublicProcumbment1_dvEn" class="box2">
		<div class="content">
			<div class="news_item">
				<a class="link_line" href="Procurment.php?ProcurmentType=1">
					<span class="bullet"></span><span>Works</span> </a><a class="link_line" href="Procurment.php?ProcurmentType=2">
						<span class="bullet"></span><span>Goods</span> </a><a class="link_line" href="Procurment.php?ProcurmentType=3">
							<span class="bullet"></span><span>Services</span> </a><a class="link_line" href="Procurment.php?ProcurmentType=4">
								<span class="bullet"></span><span>IFT and EOIs</span> </a><a class="link_line" href="NotificationofAward.php">
									<span class="bullet"></span><span>Notification of Award</span>
				
				
				</a><a class="link_line" href="../DebarredListNew.php">
					<span class="bullet"></span><span>Contractor Debar List</span> </a><a href="procurmentplan.php" id="ctl00_ctlPublicProcumbment1_anchProcurment" class="link_line"><span class="bullet">
						</span><span>Procurement Document</span> </a><a href="ProcurementGeneralNotice.php" id="ctl00_ctlPublicProcumbment1_ancGNotice" class="link_line"><span class="bullet"></span>
							<span>PROMIS Report</span> </a><a href="http://www.eprocure.gov.bd/resources/common/StdTenderSearch.jsp?keyword=LGED&h=t&Itemid=204" id="ctl00_ctlPublicProcumbment1_a3" class="link_line" target="_blank"><span class="bullet"></span><span>eTenders</span>
				</a>
			</div>
		</div>
	</div>
